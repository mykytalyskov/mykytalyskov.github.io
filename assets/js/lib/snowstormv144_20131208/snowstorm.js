...
var snowStorm = (function(window, document) {
  ...
  this.flakeWidth = 20;           // Max pixel width reserved for snow element (8 - bullet)
  this.flakeHeight = 20;          // Max pixel height reserved for snow element (8 - bullet)
  ...
  this.SnowFlake = function(type,x,y) {
    ...
    this.o.style.color = storm.randomSnowColor ? storm.getRandomColor() : storm.snowColor;
